(function(){
  ...
  function interactions(){
    ...
    if(!one('[data-interaction-style]')){
      ...
      st.textContent+='.mobileServiceRail,.orderMobileBar{display:none}.mobileServiceRail a{white-space:nowrap}.orderMobileMeta{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:6px 14px;width:100%;min-width:0}.orderMobileMeta span{font-size:12px;color:#667085;font-weight:850;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.orderMobileMeta b{font-size:17px;color:#101828;line-height:1.15;text-align:right;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.orderMobileMeta b.isHidden{display:none}.orderMobileMeta .orderMobileService{grid-column:1/-1;color:#0f766e;font-weight:950}.orderMobileActions{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:center}.orderMobilePrompt,.orderMobileSubmit,.orderMobileChoice{min-height:42px;border-radius:999px;font:inherit;font-weight:950;cursor:pointer}.orderMobilePrompt{border:1px solid rgba(15,118,110,.18);background:#eef8f6;color:#0b4f4a;padding:10px 14px;text-align:center}.orderMobilePrompt.isWide{grid-column:1/-1}.orderMobileSubmit{border:0;background:#0f766e;color:#fff;padding:10px 18px;box-shadow:0 12px 24px rgba(15,118,110,.22);white-space:nowrap}.orderMobileSubmit[hidden],.orderMobilePayChoices[hidden]{display:none!important}.orderMobilePayChoices{grid-column:1/-1;display:grid;grid-template-columns:1fr 1fr;gap:8px}.orderMobileChoice{border:1px solid rgba(217,227,224,.95);background:#fff;color:#344054;padding:10px 12px}.orderMobileChoice.active{background:#0f766e;color:#fff;border-color:#0f766e}.orderMobileChoice small{margin-left:5px;font-size:11px;font-weight:950;opacity:.82}@media(max-width:760px){.mobileServiceRail{position:sticky;top:68px;z-index:45;display:flex;gap:8px;overflow-x:auto;margin:0 0 18px;padding:8px;border:1px solid rgba(217,227,224,.92);border-radius:999px;background:rgba(255,255,255,.92);box-shadow:0 14px 34px rgba(15,23,42,.09);backdrop-filter:blur(18px);scrollbar-width:none}.mobileServiceRail::-webkit-scrollbar{display:none}.mobileServiceRail a{flex:0 0 auto;display:flex;align-items:center;justify-content:center;min-height:38px;padding:8px 14px;border-radius:999px;border:1px solid rgba(217,227,224,.95);background:#fff;color:#344054;font-size:13px;font-weight:950}.mobileServiceRail a.active{background:#0f766e;color:#fff;border-color:#0f766e;box-shadow:0 10px 22px rgba(15,118,110,.22)}.orderBox .payTabs,.orderBox .submitBtn{display:none!important}.orderMobileBar{position:fixed;left:12px;right:12px;bottom:calc(76px + env(safe-area-inset-bottom));z-index:1098;display:grid;grid-template-columns:1fr;gap:10px;padding:12px 14px;border:1px solid rgba(217,227,224,.92);border-radius:18px;background:rgba(255,255,255,.96);box-shadow:0 18px 46px rgba(15,23,42,.18);backdrop-filter:blur(18px)}body.hasMobileDock.hasOrderBar{padding-bottom:calc(214px + env(safe-area-inset-bottom))}body.isTyping .mobileDock{opacity:0!important;transform:translateY(140%)!important;pointer-events:none!important}.mobileDock,.orderMobileBar{transition:opacity .18s ease,transform .18s ease}}';

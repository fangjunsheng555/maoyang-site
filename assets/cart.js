(function(){
  ...
  const PRODUCTS = {
    ...
    chatgpt:  { key:'chatgpt',  label:'ChatGPT Plus',    subtitle:'独享账户 · 含低风险线路', amount:75,  cycle:'1月', monthly:'¥75/月',     original:158, badge:'AI 必备', highlights:['账户单独使用','GPT 5.5+ / codeX','赠送企业专线 IP'], desc:'账户独立使用，避免 IP 拥挤导致模型降智，赠送低风险企业专线。', soldThisMonth:842, image:'assets/img/product-chatgpt.jpg', accent:'#10a37f' },
    network:  { key:'network',  label:'网络节点服务',     subtitle:'不限设备 · 不限流量 · 5Gbps', amount:99, cycle:'1年', monthly:'≈¥8.3/月', original:218, badge:'必备工具', highlights:['多大厂线路港日台美英德','解锁全球流媒体/AI/社交','全加密无日志 24×7'], desc:'大厂机房多线路，最高 5Gbps，不限设备不限流量，解锁全球平台。', soldThisMonth:1580, image:'assets/img/product-network.jpg', accent:'#0f766e' }
  };

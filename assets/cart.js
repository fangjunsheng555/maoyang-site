(function(){
  ...
  const PRODUCTS = {
    ...
    netflix:  { key:'netflix',  label:'Netflix Premium', subtitle:'4K 杜比 · 一人独立车位', amount:168, cycle:'1年', monthly:'≈¥14/月',   original:398, badge:'影视首选', highlights:['4K 杜比顶规套餐','独立车位不排队','支持离线下载'], desc:'4K 杜比套餐，一人一个独立车位，4K 画质、杜比音效、离线下载与位置上锁。', soldThisMonth:956, image:'assets/img/product-netflix.jpg', accent:'#e50914' },
    disney:   { key:'disney',   label:'Disney+',         subtitle:'一人一位 · 全球可用 4K',  amount:108, cycle:'1年', monthly:'≈¥9/月',    original:268, badge:'性价比之选', highlights:['4K 杜比顶规','位置上锁不超售','全球可用不限地区'], desc:'一人一位绝不超售，全球可用 4K 杜比套餐，独立车位互不干扰。', soldThisMonth:612, image:'assets/img/product-disney.jpg', accent:'#0072d2' },
    hbomax:   { key:'hbomax',   label:'HBO Max',         subtitle:'一人一位 · 全球可用 4K',  amount:148, cycle:'1年', monthly:'≈¥12.3/月', original:348, badge:'影迷最爱', highlights:['4K 杜比顶规','全球可用','实时售后保障'], desc:'一人一位全球可用 4K 杜比套餐，一人独享一位置互不干扰。', soldThisMonth:487, image:'assets/img/product-hbomax.jpg', accent:'#7e22ce' },
    chatgpt:  { key:'chatgpt',  label:'ChatGPT Plus',    subtitle:'独享账户 · 含高质量线路', amount:75,  cycle:'1月', monthly:'¥75/月',     original:158, badge:'AI 必备', highlights:['账户单独使用','GPT 5.5+ / codeX','赠送企业专线 IP'], desc:'账户独立使用，避免 IP 拥挤导致模型降智，赠送高质量企业专线。', soldThisMonth:842, image:'assets/img/product-chatgpt.jpg', accent:'#10a37f' },
    network:  { key:'network',  label:'网络节点服务',     subtitle:'不限设备 · 不限流量 · 5Gbps', amount:99, cycle:'1年', monthly:'≈¥8.3/月', original:218, badge:'必备工具', highlights:['多大厂线路港日台美英德','解锁全球流媒体/AI/社交','全加密无日志 24×7'], desc:'大厂机房多线路，最高速率 5Gbps，不限设备不限流量，解锁全球平台。', soldThisMonth:1580, image:'assets/img/product-network.jpg', accent:'#0f766e' }
  };

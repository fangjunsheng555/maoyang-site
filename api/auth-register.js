...
const { clean, normalizeEmail, validEmail, validPassword, hashPassword, randomId, formatBeijingTime, grantNewUserBonus, findUserByEmail, attachSession } = require('./lib/maoyang-auth.js');
